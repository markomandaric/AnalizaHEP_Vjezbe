...
// Wed Jan 12 12:17:02 2022 by ROOT version 6.24/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void	    TMVA();
   TH1F*            histo_signal[15];
   TH1F*            histo_background[15];
};

#endif

#ifdef Anlayzer_cxx
Anlayzer::Anlayzer(TTree *tree) : fChain(0) 
{
	  if (tree == 0) {
  ...
  histo_signal[0] = new TH1F("hs_1", "ele_pt", 100, 0, 100);
  histo_background[0] = new TH1F("hb_1", "ele_pt", 100, 0, 100);
  histo_signal[1] = new TH1F("hs_2", "scl_eta", 100, -3, 3);
  histo_background[1] = new TH1F("hb_2", "scl_eta", 100, -3, 3);
  histo_signal[2] = new TH1F("hs_3", "ele_hadronicOverEm", 100, 0, 0.1);
  histo_background[2] = new TH1F("hb_3", "ele_hadronicOverEm", 100, 0, 0.1);
  histo_signal[3] = new TH1F("hs_4", "ele_gsfchi2", 100, 0, 5);
  histo_background[3] = new TH1F("hb_4", "ele_gsfchi2", 100, 0, 5);
  histo_signal[4] = new TH1F("hs_5", "ele_fbrem", 100, -1.2, 1.2);
  histo_background[4] = new TH1F("hb_5", "ele_fbrem", 100, -1.2, 1.2);
  histo_signal[5] = new TH1F("hs_6", "ele_ep", 100, 0, 5);
  histo_background[5] = new TH1F("hb_6", "ele_ep", 100, 0, 5);
  histo_signal[6] = new TH1F("hs_7", "ele_eelepout", 100, 0, 5);
  histo_background[6] = new TH1F("hb_7", "ele_eelepout", 100, 0, 5);
  histo_signal[7] = new TH1F("hs_8", "ele_pfChargedHadIso", 100, 0, 0.3);
  histo_background[7] = new TH1F("hb_8", "ele_pfChargedHadIso", 100, 0, 0.3);
  histo_signal[8] = new TH1F("hs_9", "ele_expected_inner_hits", 100, 0, 0.3);
  histo_background[8] = new TH1F("hb_9", "ele_expected_inner_hits", 100, 0, 0.3);
  histo_signal[9] = new TH1F("hs_10", "ele_sclRawE", 100, 0, 0.3);
  histo_background[9] = new TH1F("hb_10", "ele_sclRawE", 100, 0, 0.3);
  histo_signal[10] = new TH1F("hs_11", "ele_ecalE", 100, 0, 0.3);
  histo_background[10] = new TH1F("hb_11", "ele_ecalE", 100, 0, 0.3);
  histo_signal[11] = new TH1F("hs_12", "ele_sclNclus", 100, 0, 0.3);
  histo_background[11] = new TH1F("hb_12", "ele_sclNclus", 100, 0, 0.3);
  histo_signal[12] = new TH1F("hs_13", "ele_oldhebc", 100, 0, 0.3);
  histo_background[12] = new TH1F("hb_13", "ele_oldhebc", 100, 0, 0.3);
  histo_signal[13] = new TH1F("hs_14", "ele_oldcircularity", 100, 0, 0.3);
  histo_background[13] = new TH1F("hb_14", "ele_oldcircularity", 100, 0, 0.3);
  histo_signal[14] = new TH1F("hs_15", "ele_kfhits", 100, 0, 0.3);
  histo_background[14] = new TH1F("hb_15", "ele_kfhits", 100, 0, 0.3);
...
Int_t Anlayzer::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Anlayzer::LoadTree(Long64_t entry)
{
...
void Anlayzer::Show(Long64_t entry)
{
...
Int_t Anlayzer::Cut(Long64_t entry)
{
